...
export class ApiService {
  ...
  companyContactList(data) {
    return this.http.post(
      `${this.baseComapnyManagemtURL}/getCompanyContacts `,
      data
    );
  }
  ...
  createCompanyContact(data) {
    return this.http.post(
      `${this.baseComapnyManagemtURL}/createCompanyContact`,
      data
    );
  }
  ...
  updateCompanyContact(data) {
    return this.http.post(
      `${this.baseComapnyManagemtURL}/editCompanyContact`,
      data
    );
  }
  ...
  companyDetailView() {
    return this.http.get(
      `${this.baseComapnyManagemtURL}/getAllCompanyInteraction`
    );
  }
  ...
  getFeatureList() {
    ...
    return this.http.post(`${this.baseURL}/getFeatures`, {
      roleType: roleName
    });
  }
  resetPassword(data) {
